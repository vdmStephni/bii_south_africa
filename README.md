...
Available biome-specific ecological condition data can subsequently be used to refine intensity scores for untransformed segments. This has initially been tested in the Thicket biome.

## Workflow documents

- `segmentation.qmd`
- `land-use-reclassification.qmd`
- `segment-allocation.qmd`
- `thicket-intensity.qmd`
