...
The original NLC classes (for details see [#nlclooklup](#nlclooklup)) were grouped into six broad BII land use categories:
...
-   `unknown` means that intensity has not yet been assigned from NLC alone;
